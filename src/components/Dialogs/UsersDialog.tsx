...
export default function UserDialog() { 
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <Button type="button" className="bg-amber-300 text-black font-semibold">Pesquisar Usuário</Button>
      </DialogTrigger>
        <DialogContent>
          <DialogHeader>
        ...
        <EditUserMonthlyHour userHours={user?.monthlyHours.toString() || ""} userId={user?.id.toString() || ""}/>
      </DialogContent>
    </Dialog>
