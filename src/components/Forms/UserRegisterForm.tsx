...
const registerFormSchema = z.object({
  ...
  contact: z.string().min(11, "Contato requerido!").max(
    11,
    "Numero muito grande",
  ),
    ...
    createUserMutation.mutate(values, {
      ...
      onError: () => {
        toast({
          ...
          description:
            "Confira os dados e tente novamente, alias o usuário já não tem cadastro?",
          variant: "destructive",
        });
      },
    });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Este é o numero de contato do usuário
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Esta será a senha de acesso do usuário
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
